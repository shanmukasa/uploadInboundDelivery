		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload Inbound Delivery",
									"targetURL": "#comtmcazuploadinbounddelivery-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtmcazuploadinbounddelivery-display": {
								"semanticObject": "comtmcazuploadinbounddelivery",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tmca.zuploadinbounddelivery",
									"url": sap.ui.require.toUrl("com/tmca/zuploadinbounddelivery")
								}
							}
						}
					}
